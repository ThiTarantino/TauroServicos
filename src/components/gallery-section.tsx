...
const galleryImages = [
  {
    src: "/modern-electrical-installation-work.jpg",
    alt: "Instalação elétrica profissional",
  },
  {
    src: "/professional-house-painting-interior.jpg",
    alt: "Pintura interna residencial",
  },
  {
    src: "/masonry-construction-work-bricklaying.jpg",
    alt: "Serviços de alvenaria",
  },
  {
    src: "/modern-bathroom-renovation-tiles.jpg",
    alt: "Reforma de banheiro",
  },
  {
    src: "/exterior-house-painting-professional.jpg",
    alt: "Pintura externa de fachada",
  },
  {
    src: "/electrical-panel-installation.jpg",
    alt: "Quadro elétrico moderno",
  },
  {
    src: "/beautiful-garden-landscaping-with-green-grass-and-.jpg",
    alt: "Jardinagem e paisagismo",
  },
  {
    src: "/home-maintenance-and-repair-services-handyman-work.jpg",
    ...
    <section id="galeria" className="bg-muted/30 py-16 md:py-20">
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center">
          <h2 className="mb-3 text-3xl font-bold text-foreground md:text-4xl">Galeria de Trabalhos</h2>
